       ...
       return (
              <Link href={href}>
                     <div className="w-auto h-fit border-2 rounded border-gray-100 flex flex-col justify-center items-center group duration-500 hover:shadow-2xl mb-10 bg-primary">
                            ...
                            <div className="w-full h-full py-12 px-10 bg-primary text-white rounded flex flex-col justify-between items-center">
                                   <h1 className="text-lg md:text-2xl font-extrabold uppercase text-center">{name}</h1>
                                   <p className="text-white font-bold mt-2 text-center ">{discription}</p>
                                   <div className="w-full flex justify-between space-y-2 flex-wrap items-center mt-6">
                                          <span>{rating}</span>
